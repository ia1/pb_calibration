 /*  File: get_mixture_dip121.c // computes and analyses AAF( maf) distribution over variant positions from vcfq files
 ...
 *-------------------------------------------------------------------
 * Description: computes maf distrib over variant positions from just extracted 6 fileld and stores histogram file 'distr' 
